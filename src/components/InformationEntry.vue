                    ...
                    <el-row :gutter="20">
                      ...
                      <el-col :span="20" :xs="24">
                        ...
                        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
                          ...
                          <el-table-column v-if="columns[1].visible" key="userName" :show-overflow-tooltip="true" label="用户名称" align="center" prop="userName" />
                          <el-table-column v-if="columns[2].visible" key="nickName" :show-overflow-tooltip="true" label="用户昵称" align="center" prop="nickName" />
                          <el-table-column v-if="columns[3].visible" key="deptName" :show-overflow-tooltip="true" label="部门" align="center" prop="dept.deptName" />
