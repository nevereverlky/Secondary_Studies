              ...
              <div class="d-flex align-items-center">
                <div class="mr-auto">
                  ...
                  <div class="d-inline-block align-items-center">
                    <nav>
                      <ol class="breadcrumb">
                        <li class="breadcrumb-item"><router-link tag="a" to="/overallview"><i class="fa fa-home" aria-hidden="true"></i></router-link></li>
                        ...
                        <div class="box box-primary pull-up">
                          <div class="box-body">
                            <div class="d-flex align-items-center font-size-18">
                              <div class="icon">
                                <i class="fa fa-puzzle-piece text-white mr-10"></i>
                              </div>
                            ...
                            <div class="d-flex align-items-center flex-wrap">
                              ...
                              <div class="badge badge-light badge-pill ml-10">
                                <div class="d-flex align-items-baseline">
                                  ...
                                  <span class="fa fa-arrow-up" style="margin-left: 5px"></span>
                                </div>
                              </div>
                            </div>
                ...
                <div class="col-xl-3 col-md-6 col-12">
                        <div class="box box-success pull-up">
                          <div class="box-body">
                            <div class="d-flex align-items-center font-size-18">
                              <div class="icon">
                                <i class="fa fa-paper-plane text-white mr-10"></i>
                              </div>
                ...
                <div class="col-xl-3 col-md-6 col-12">
                        <div class="box box-primary pull-up">
                          <div class="box-body">
                            <div class="d-flex align-items-center font-size-18">
                              <div class="icon">
                                <i class="fa fa-exclamation-triangle text-white mr-10"></i>
                              </div>
                            ...
                            <div class="d-flex align-items-center flex-wrap">
                              ...
                              <div class="badge badge-light badge-pill ml-10">
                                <div class="d-flex align-items-baseline">
                                  ...
                                  <span class="fa fa-arrow-down" style="margin-left: 5px"></span>
                                </div>
                              </div>
                            </div>
                            <small class="font-weight-medium d-block text-white-50">Total for this month</small>
                ...
                <div class="col-xl-3 col-md-6 col-12">
                        <div class="box box-success pull-up">
                          <div class="box-body">
                            <div class="d-flex align-items-center font-size-18">
                              <div class="icon">
                                <i class="fa fa-mortar-board text-white mr-10"></i>
                              </div>
              ...
              <div>
                <div>
                  <div class="btn-group float-sm-right" style="margin-bottom: 20px">
                    <button type="button" class="btn btn-success btn-sm waves-effect waves-light"><i class="fa fa-download mr-1"></i>导出名单</button>
                  </div>
                </div>
